...
| Mock tests | `ielts_practice_read_session`, `ielts_practice_submit_session`, `ielts_footprints_list` for owned mock history; catalog/start data should be exposed by IELTS Buddy before portable Agents can list mock papers directly | `https://ieltsbuddy.igocn.cn/mock` |
...
| Study plans | `ielts_study_plans_list`, `ielts_study_plans_get`, `ielts_study_plans_draft`, `ielts_study_plans_next_actions`, `ielts_study_plans_create`, `ielts_study_plans_update`, `ielts_study_plans_update_task`, `ielts_study_plans_review`, `ielts_study_plans_delete` | `https://ieltsbuddy.igocn.cn/plans` |
...
| Speaking topic weaving | `ielts_speaking_materials_list`, `ielts_speaking_materials_create`, `ielts_speaking_materials_update`, `ielts_speaking_materials_archive`, `ielts_speaking_materials_start_practice` | `https://ieltsbuddy.igocn.cn/ai-apps/speaking-topic-weaver` |
