...
| Speaking topic weaving | Local `../workflows/speaking-topic-builder/WORKFLOW.md`; `ielts_speaking_materials_list`, data-only `ielts_speaking_materials_create`, data-only `ielts_speaking_materials_update`, `ielts_speaking_materials_archive`, `ielts_speaking_materials_start_practice`; create/update must include exact question links chosen locally | `https://ieltsbuddy.igocn.cn/ai-apps/speaking-topic-weaver` |
...
For browser-owned attempts that produce results, transcripts, answers, or notes, continue locally with the relevant review workflow instead of rebuilding the browser UI: `../workflows/listening-error-review/WORKFLOW.md`, `../workflows/reading-review/WORKFLOW.md`, or `../workflows/speaking-coach/WORKFLOW.md`.
